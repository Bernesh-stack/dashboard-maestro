...
{earningData.map((item) => (
  <div 
    key={item.title} 
    className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-2xl md:w-56 p-8 pt-9'
  >
    <button 
      type='button' 
      ...
      <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780'>
        ...
        <div className='mt-10 flex gap-10 flex-wrap justify-center'>
          <div className='border-r-1 border-color m-4 pr-10'>
            <div>
              <p>
                <span className='text-3xl font-semibold'>$87654</span>
              ...
              <p className='text-gray-500 mt-1'>
                Budget
                        ...
                        <div className='mt-8'>
              <p>
                <span className='text-3xl font-semibold'>$48654</span>
              </p>
...
<div className='border-r-1 border-color m-4 pr-10 min-w-[250px] min-h-[80px]'>
<SparkLine 
